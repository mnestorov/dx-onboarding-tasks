...
if ( ! class_exists( 'Display_Remote_Urls' ) ) {
	...
	class Display_Remote_Urls {
		 ...
		 * @return void
		 */
		public function sanitized_links_plugin_menu() {
			add_menu_page( 'Display Remote Urls Plugin', 'Display Remote Urls', 'manage_options', DR_URL_SLUG . '/sanitized-links-admin.php', array( $this, 'sanitized_links_options' ) );
		}
